...
2. Open Service Operations Workspace by navigating to `</now/sow>`.
      ...
      ![Open Service Operations Workspace](images/sow_home_1.png)
...
5. Open the Incident in a workspace tab.
   ...
   ![Open the VPN Incident](images/sow_home_3.png)
...
2. Confirm that the Incident is assigned to `<NDIT-Lab Agent>`.

(Need a hint? Open the Details tab)

   ![Confirm the assignment group](images/sow_home_4.png)
...
3. Confirm the related service and CI:
   ...
   ![Review the related service and CI](images/sow_home_5.png)

4. Review the activity stream or record history before changing the Incident.



5. Assign the Incident to yourself, and change the state to **In Progress**.

   ![Assign the Incident and set it to In Progress](images/sow_home_6.png)
...
6. Add the following work note:
   ...
   ![Add the initial investigation work note](images/sow_home_7.png)
...
2. Confirm that the VPN troubleshooting Playbook is attached to your Incident and review its visible stages or activities before starting.
   ...
   ![Review the VPN troubleshooting Playbook](images/sow_home_8.png)
...
4. Open and review `<KB0018355 v1.0>` when the Playbook presents the knowledge step.
   ...
   ![Review KB0018355 version 1.0](images/sow_home_10.png)

5. Complete the guided troubleshooting activity using the checklist in `<KB0018355 v1.0>`.

   For this simulation, simulate following the instructions rather than making changes to your own device or credentials.

   ![Complete the VPN troubleshooting checklist](images/sow_home_11.png)
...
6. When the Playbook asks whether the VPN connection is now successful, select **YES** so the lab continues through the active-Outage path.
   ...
   ![Select for the connection-success question](images/sow_home_14.png)
...
8. Review the Outage information presented by the Playbook and confirm that it relates to your Incident and `<Corporate VPN - Production>`.
   ...
   ![Review the active related Outage](images/sow_home_20.png)
...
9. Complete the Playbook activity that records restoration of the VPN service.
   ...
   ![Complete the Outage restoration activity](images/sow_home_17.png)
...
1. Use the related information available from the Incident or Playbook to verify that the associated Outage now has an **End** value.
   ...
   ![Verify the Outage End value](images/sow_home_20.png)
